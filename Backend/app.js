...
import userRoutes from './routes/user.route.js'; // Skills included here
...
app.use('/api/user', userRoutes); // Skills functionality included here
app.use('/api/user/experience', experienceRoutes);
app.use('/api/user/education', educationRoutes);
// ❌ Removed separate skills routes: app.use('/api/skills', skillsRoutes);
...
async function startServer() {
    try {
        ...
        app.listen(PORT, () => {
            ...
            console.log(`User API (with skills): http://localhost:${PORT}/api/user`);
